...
/* The following structures were relocated from interface.c and are exposed here
 * to allow the shim implementation (src/shim.c) to access internal members and
